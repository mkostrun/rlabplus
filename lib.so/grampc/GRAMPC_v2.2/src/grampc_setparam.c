...
void grampc_fprintparam(FILE *f, const typeGRAMPC *grampc)
{
  fprintf(f, "%s", "-- GRAMPC PARAMETERS --\n");
  fprintf(f, "     Nx: %d\n", grampc->param->Nx);
  fprintf(f, "     Nu: %d\n", grampc->param->Nu);
  fprintf(f, "     Np: %d\n", grampc->param->Np);
  fprintf(f, "     Nc: %d\n", grampc->param->Nc);
  ...
  fprint_vector(f, "     x0: ", grampc->param->x0, grampc->param->Nx);
  fprint_vector(f, "   xdes: ", grampc->param->xdes, grampc->param->Nx);

  fprint_vector(f, "     u0: ", grampc->param->u0, grampc->param->Nu);
  fprint_vector(f, "   udes: ", grampc->param->udes, grampc->param->Nu);
  fprint_vector(f, "   umax: ", grampc->param->umax, grampc->param->Nu);
  fprint_vector(f, "   umin: ", grampc->param->umin, grampc->param->Nu);

  fprint_vector(f, "     p0: ", grampc->param->p0, grampc->param->Np);
  fprint_vector(f, "   pmax: ", grampc->param->pmax, grampc->param->Np);
  fprint_vector(f, "   pmin: ", grampc->param->pmin, grampc->param->Np);
